...
const TopBar = ({ isDark, onToggleTheme }: TopBarProps) => {
    ...
    <div className="border-b pt-1.5 pb-4 px-4 mb-2 mt-2 border-stone-200">
      <div className="flex flex-wrap items-center justify-between gap-3 p-0.5 ">
        <div>
          ...
          <span className="text-bold block text-xs text-stone-500">
            {currentDate}
          </span>
        </div>
        <div className="flex gap-2.5 items-center justify-center">
          <button
            ...
            className="bg-stone-300 p-2.5 rounded-xl hover:bg-stone-200 hover:text-violet-500"
          >
            {isDark ? <FiSun/> : <FiMoon/>}
          </button>
